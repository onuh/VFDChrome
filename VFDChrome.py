...
if __name__ == "__main__":
    ...
    if extract_version_folder() == None:
        error1 = Mbox('Chrome Error', 'Google Chrome Browser is not Installed on Your Computer. You need Google Chrome installed to use this application. Do you want to open website to download google chrome browser?', 0x10|0x4)
        if error1 == 6:
